        ...
        <!-- Proveedores -->
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    {!! Form::open([null, 'method' => 'PUT', 'v-on:submit.prevent' => 'actualizarProveedor()']) !!}
                        <!-- Código -->
                        ...
                        <div class="form-check">
                            <label class="form-radio-label">
                                {!! Form::radio('estado', '1', null, ['class' => 'form-radio-input', 'v-model' => 'proveedor.estado'])  !!}
                                <span class="form-radio-sign">Habilitar</span>
                            </label>
                            <label class="form-radio-label">
                                {!! Form::radio('estado', '0', null, ['class' => 'form-radio-input', 'v-model' => 'proveedor.estado'])  !!}
